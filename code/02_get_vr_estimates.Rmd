...
```{r}
ggplot(city.asdr) +
  geom_line(aes(x=agegp10, y=asdr, color=state_abbrev,
                group=interaction(state_abbrev, sex))) +
  facet_grid(~ sex) +
  theme_minimal()
```
...
```{r}
ggplot(region.asdr) +
  geom_line(aes(x=agegp10, y=asdr, color=region,
                group=interaction(region, sex))) +
  facet_grid(~ sex) +
  theme_minimal()
```
...
```{r}
ggplot(national.asdr) +
  geom_line(aes(x=agegp10, y=asdr,
                group=sex)) +
  facet_grid(~ sex) +
  theme_minimal()
```
...
```{r}
ggplot(city.asdr.adj) +
  geom_point(aes(x=vr_asdr, y=asdr, color=state_abbrev)) +
...
```{r}
ggplot(region.asdr.adj) +
  geom_point(aes(x=vr_asdr, y=asdr, color=region)) +
  geom_abline(intercept=0, slope=1) +
  theme_minimal()
```
...
chk_region_47q18 %>%
  ggplot(.) +
  geom_point(aes(x=q.47.18.vr, y=q.47.18, color=region)) +
  geom_abline(intercept=0, slope=1) +
  theme_minimal()
```
