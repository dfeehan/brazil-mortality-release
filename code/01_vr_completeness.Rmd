...
sampsize.table.rendered <- pander::pandoc.table.return(sampsize.table,
               ...
               big.mark=',',
               split.cells=c(1, 1, 20, 10, 10, 10, 10),
               split.table=Inf,
               justify=c('center', 'center', 'left', 'right', 'right', 'right', 'right'),
               caption="(\\#tab:sampsize) Number of interviews conducted, response rates, and estimated vital registration completeness for each of the 27 cities in our sample.")
