...
```{r}
message(format(Sys.time()), " -- Starting VR city comparison")
...
```{r}
message(format(Sys.time()), " -- Starting VR region comparison")
rmarkdown::render(comparison_script_fn,
...
```{r}
message(format(Sys.time()), " -- Starting VR national comparison")
rmarkdown::render(comparison_script_fn,
...
```{r}
message(format(Sys.time()), " -- Starting adjusted VR city comparison")
rmarkdown::render(comparison_script_fn,
...
```{r}
message(format(Sys.time()), " -- Starting adjusted VR region comparison")
rmarkdown::render(comparison_script_fn,
...
```{r}
message(format(Sys.time()), " -- Starting adjusted VR national comparison")
rmarkdown::render(comparison_script_fn,
